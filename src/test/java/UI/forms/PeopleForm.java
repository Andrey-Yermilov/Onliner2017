...
/**
 * Форма с новостями раздела 'Люди'
 */
public class PeopleForm extends BaseForm {
    private static final String formLocator = "//li[@class='b-main-navigation__item b-main-navigation__item-active']/a[contains(text(),'Люди')]";

    public PeopleForm() {
        super(By.xpath(formLocator), "People, Onliner");
    }
