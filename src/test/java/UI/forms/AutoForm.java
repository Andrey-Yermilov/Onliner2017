...
/**
 * Форма с новостями раздела 'Авто'
 */
public class AutoForm extends BaseForm {
    private static final String formLocator = "//li[@class='b-main-navigation__item b-main-navigation__item-active']/a[contains(text(),'Авто')]";

    public AutoForm() {
        super(By.xpath(formLocator), "Auto, Onliner");
    }
