...
/**
 * Форма с новостями раздела 'Технологии'
 */
public class TechForm extends BaseForm {
    private static final String formLocator = "//li[@class='b-main-navigation__item b-main-navigation__item-active']/a[contains(text(),'Технологии')]";

    public TechForm() {
        super(By.xpath(formLocator), "Technologies, Onliner");
    }
